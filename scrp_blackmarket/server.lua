...
RegisterServerEvent('scrp_blackmarket:buygun')
AddEventHandler("scrp_blackmarket:buygun", function(name, price, weapon, lvl)
    ...
    TriggerEvent('redemrp:getPlayerFromId', _source, function(user)
        ...
        if user.getMoney() >= price then
            if level >= lvl then
                ...
                TriggerClientEvent('scrp_blackmarket:alert', source, "You are not a high enough level!")
            end
        else
            TriggerClientEvent('scrp_blackmarket:alert', source, "You dont have enough money!")
        end
    end)
end)

RegisterServerEvent('scrp_blackmarket:buyammo')
AddEventHandler('scrp_blackmarket:buyammo', function(price, item)
local _source = source
	TriggerEvent('redemrp:getPlayerFromId', _source, function(user) 
        if user.getMoney() >= price then
            ...
            TriggerClientEvent('scrp_blackmarket:alert', _source, "You dont have enough money!")
        end
	end)
end)
...
AddEventHandler("RegisterUsableItem:revolver_ammo", function(source)
    if Config.RedemrpInventory2 == false then
        TriggerClientEvent('scrp_blackmarket:giveammo', source, "WEAPON_REVOLVER_CATTLEMAN")
...
AddEventHandler("RegisterUsableItem:pistol_ammo", function(source)
    if Config.RedemrpInventory2 == false then
        TriggerClientEvent('scrp_blackmarket:giveammo', source, "WEAPON_PISTOL_MAUSER")
...
AddEventHandler("RegisterUsableItem:22_ammo", function(source)
    if Config.RedemrpInventory2 == false then
        TriggerClientEvent('scrp_blackmarket:giveammo', source, "WEAPON_RIFLE_VARMINT")
...
AddEventHandler("RegisterUsableItem:rifle_ammo", function(source)
    if Config.RedemrpInventory2 == false then
        TriggerClientEvent('scrp_blackmarket:giveammo', source, "WEAPON_RIFLE_BOLTACTION")
...
AddEventHandler("RegisterUsableItem:shotgun_ammo", function(source)
    if Config.RedemrpInventory2 == false then
        TriggerClientEvent('scrp_blackmarket:giveammo', source, "WEAPON_SHOTGUN_DOUBLEBARREL")
...
AddEventHandler("RegisterUsableItem:repeator_ammo", function(source)
    if Config.RedemrpInventory2 == false then
        TriggerClientEvent('scrp_blackmarket:giveammo', source, "WEAPON_REPEATER_EVANS")
...
AddEventHandler("RegisterUsableItem:snipe_ammo", function(source)
    if Config.RedemrpInventory2 == false then
        TriggerClientEvent('scrp_blackmarket:giveammo', source, "WEAPON_SNIPERRIFLE_CARCANO")
...
AddEventHandler("RegisterUsableItem:arrows", function(source)
    if Config.RedemrpInventory2 == false then
        TriggerClientEvent('scrp_blackmarket:giveammo', source, "WEAPON_BOW")
...
AddEventHandler("RegisterUsableItem:knives", function(source)
    if Config.RedemrpInventory2 == false then
        TriggerClientEvent('scrp_blackmarket:giveammo', source, "WEAPON_THROWN_THROWING_KNIVES")
